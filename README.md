...
|     工具      | 版本号 |                             下载                             |
| :-----------: | :----: | :----------------------------------------------------------: |
|      JDK      |  1.8   | https://download.java.net/openjdk/jdk8u41/ri/openjdk-8u41-b04-windows-i586-14_jan_2020.zip |
...
```txt
配置虚拟机地址，将项目中所有192.168.5.94更换为自己的虚拟机网络地址
```
...
除此之外，在gulimall-third-party模块中的config配置OSS相关配置。
```
